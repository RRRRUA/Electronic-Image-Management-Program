...
public class PictureNode extends Label{
    ...
    public BooleanProperty selected = new SimpleBooleanProperty();//绑定属性类型
    ...
    public void setSelected(boolean value) {
        ...
        for (PictureNode pNode : selectedPictures) {
            size += pNode.getImageFile().length();
        }
        mainScene.getTextTwo().setText("已选中 "+selectedPictures.size()+" 张图片,大小为"+size+"KB");
        n=selectedPictures.size();
    }
